...
node_colors = [f'rgba{tuple(int(255*x) for x in cmap(norm(g))[:3]) + (0.9,)}' for g in groups]
...
for edge in G.edges(data=True):
    x0, y0, z0 = pos[edge[0]]
    x1, y1, z1 = pos[edge[1]]
    mx, my, mz = (x0+x1)/2 + np.random.uniform(-0.1,0.1), (y0+y1)/2 + np.random.uniform(-0.1,0.1), (z0+z1)/2 + np.random.uniform(-0.1,0.1)
