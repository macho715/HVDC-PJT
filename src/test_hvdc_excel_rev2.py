...
class TestHVDCExcelREV2:
    ...
    def test_raw_data_counts_rev2(self):
        ...
        assert len(hitachi_df) == 5552, f"Hitachi should have 5,552 records, got {len(hitachi_df)}"
        assert len(simense_df) == 2227, f"Simense should have 2,227 records, got {len(simense_df)}"
    ...
    def test_standardize_case_list(self):
        ...
        assert 'Status_Storage' in standardized.columns, "Status_Storage column should exist"
        assert 'Status_Location' in standardized.columns, "Status_Location column should exist"
        
        # Check dtype casting
        assert standardized['FLOW_CODE'].dtype == 'Int64', "FLOW_CODE should be Int64 nullable"
    ...
    def test_assert_suite_rev2(self):
        ...
        assert pre_arrival_count > 0, f"Pre-Arrival should have records, got {pre_arrival_count}"
    ...
    def test_excel_formatting(self):
        ...
        assert file_size > 50000, f"File should be substantial size, got {file_size} bytes"
