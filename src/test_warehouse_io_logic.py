...
class TestWarehouseIOLogic:
    ...
    def test_warehouse_outbound_calculation_should_exclude_site_items(self):
        ...
        assert (
            status_counts.get("warehouse", 0) == 2
        )  # DSV Indoor 2건 (TEST001, TEST003)
        ...
        extended_data = pd.DataFrame(
            {
                ...
                "DSV Outdoor": [
                    datetime(2024, 1, 20) if 6 <= i <= 10 else None
                    for i in range(1, 21)
                ],
                "DSV Al Markaz": [
                    datetime(2024, 2, 1) if 11 <= i <= 15 else None
                    for i in range(1, 21)
                ],
                "MOSB": [
                    datetime(2024, 2, 10) if 16 <= i <= 17 else None
                    for i in range(1, 21)
                ],
                "MIR": [
                    datetime(2024, 3, 1) if 18 <= i <= 20 else None
                    for i in range(1, 21)
                ],
                "SHU": [None] * 20,
                "DAS": [None] * 20,
        ...
        monthly_data = pd.DataFrame(
            {
                ...
                "MOSB": [
                    datetime(2024, i, 20) if 7 <= i <= 12 else None
                    for i in range(1, 13)
                ],
                "DSV Outdoor": [None] * 12,
